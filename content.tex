...
\begin{table}[Mean squared error rates for the models]
\centering
\caption{}
\label{error-rates}
\begin{tabular}{l|lll}
...
results in a $p$-value of $0.6632921391951752$,
...
($p = 0.16099779003670434$ and $p = 0.3516508344172751$, respectively).
